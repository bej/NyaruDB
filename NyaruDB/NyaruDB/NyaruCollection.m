...
- (NSMutableArray *)putDocuments:(NSArray *)documents
{
    ...
    NSMutableArray *docs = [NSMutableArray arrayWithCapacity:documents.count];
    NSMutableArray *docsData = [NSMutableArray arrayWithCapacity:documents.count];
    ...
    dispatch_async(_accessQueue, ^(void) {
        ...
        for (NSInteger i = 0; i < docs.count; i++) {
            ...
            NSDictionary *doc = docs[i];
            NSData *docData = docsData[i];
            // document key
            NSString *docKey = [doc objectForKey:NYARU_KEY];
